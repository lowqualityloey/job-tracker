...
- **Last Updated**: 2026-09-10 23:00 UTC — `pk:checkpoint` 002: M2a.1–M2a.4 verified (68 tests, AC-1…AC-10), M2a.5 is the remaining gate
...
1. **Agent**: M2a.5 first step — **build the error-code contract matrix**: one row per `RepositoryError` code,
