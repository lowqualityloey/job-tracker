...
| Wrong-typed body → `400` + `code` + pointer | `-069` | **PR #58, open** |

**23 ladder rows (`-047`…`-069`), 21 `TDD-EXEC` records, 13 ACs verified / 4 open (= 17, asserted by the edit script at every write).** `-063`, `-064`, `-065` remain unexecuted and gated; AC-12/13/14/18 are the four open ACs and all four sit behind the same owner answer (§5).
